...
const About = () => {
    return (
        <div className=' w-full h-screen overflow-hidden text-[#8f8f8f] dark:bg-black bg-amber-50 '>
            ...
            <div className=" ">
                <div className=" mx-[7%] gap-[2%] grid grid-cols-2">
                    <div className="">
                        ...
                        <motion.div whileHover={{ background: `linear-gradient(to left, #ffb400 100%, transparent 50%)`, }} className=" dark:text-white text-[#8b8b8b] hover:text-white cursor-pointer text-[1vw] font-bold rounded-full flex justify-around items-center w-[35%] border border-amber-400">
                            <div className="uppercase w-[90%]  flex justify-center items-center ">
                                Download CV
                            </div>
                            <div className="text-white h-[46px] text-2xl flex justify-center items-center bg-amber-400 rounded-full p-2 w-[25%] "><FaDownload /></div>
                        </motion.div>
                    </div>
                    <div className=" grid grid-cols-2">
                        <div className="flex justify-center items-center ">
                            <div className="uppercase border border-[#8f8f8f] w-[90%] h-[80%] rounded">
                                <p>12+</p>
